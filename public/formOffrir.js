...
var $addNewItem = $('<a href="#" id="ajouterEchantillon" class="btn btn-info">Ajouter nouvel échantillon </a>');
// when the page is loaded and ready
$(document).ready(function () {
    // get the collectionHolder, initilize the var by getting the list;
    $collectionHolder = $('#offrir_list');
...
function addRemoveButton ($panel) {
    ...
    var $removeButton = $('<a href="#" class="btn btn-danger">Supprimer cet échantillon</a>');
